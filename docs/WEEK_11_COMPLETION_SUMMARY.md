...
### Basic Usage
```python
from src.memory.prospective.prospective_memory import create_prospective_memory
from datetime import datetime, timedelta

# Create in-memory instance (no dependencies)
pm = create_prospective_memory(use_vector=False)
